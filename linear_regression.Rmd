...
multi_fit_4 = 
  ...
  mutate(
    rmse_fit_2 = map2_dbl(multi_fit_2, test, ~rmse(model = .x, data = .y)),
    rmse_fit_3 = map2_dbl(multi_fit_3, test, ~rmse(model = .x, data = .y)),
    rmse_fit_4 = map2_dbl(multi_fit_4, test, ~rmse(model = .x, data = .y)))
```
...
The two line are parallel. There is no interatcion between gini index and urbanization
